...
// ✅ FIX 1: Move static components OUTSIDE the main component
...
const ChatWidget = () => {
  ...
  const getWrapperClasses = () => {
    const base = 'fixed inset-0 z-50 flex transition-all duration-500 ease-out font-sans';
    switch (viewMode) {
  ...
  const isDocked = viewMode === VIEW_MODES.DOCKED_SIDEBAR;
  const dimensions = getCardDimensions();

  // ✅ FIX 2: We removed the internal components (ChatHeader, ChatMessages, ChatInputField)
  // and simply inlined their JSX below. This ensures React maintains the Virtual DOM 
  // structure correctly, preserving input focus.
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100/80 bg-white rounded-t-3xl">
              <div className="flex items-center gap-3">
                <BotAvatar size="md" />
                <div>
                  <h2 className="text-[16px] font-semibold text-gray-900 tracking-tight">Agentforce</h2>
                  <div className="flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></span>
                    <p className="text-[12px] text-emerald-600 font-medium">Online</p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  <AnimatePresence>
                    {isDropdownOpen && (
                      ...
                      >
                        <button className="w-full flex items-center gap-3 px-4 py-3 text-[14px] text-gray-700 hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-[14px] text-red-600 hover:bg-red-50 transition-colors duration-150"
                        >
